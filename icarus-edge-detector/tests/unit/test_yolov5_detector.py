...
"max_batch_size": 1, "dtype": np.float16, "confidence": 0.8, "image_size": (640, 640), "n_classes": 80, "ratio": (1.796875, 1.09375), "labels": get_labels_from_txt_file()}
...
def test_can_detect_anything_on_preprocessed_test_image():
    ...
    for i in range(len(detections)):
        try:
            ...
            cv2.rectangle(data.raw_image, (box[0], box[1]), (box[2], box[3]), (255, 0, 0), 5)
